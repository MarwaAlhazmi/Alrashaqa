...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td>
        <asp:RadioButtonList ID="rbAdd" runat="server" CssClass="right" 
            ...
            <asp:ListItem>إضافة نوع سند صرف</asp:ListItem>
        </asp:RadioButtonList>
        </td>
    ...
    <td>
        ...
        <asp:Panel ID="pnlWith" runat="server" GroupingText="إضافة نوع سند صرف" 
            Visible="false">
        <table width="100%">
        <tr>
        <td>

            <asp:DropDownList ID="ddlWDep" runat="server" CssClass="tb7" 
                AppendDataBoundItems="True" Width="160px">
            </asp:DropDownList>
        ...
        <td style="width:120px">
            ...
            <asp:Label ID="lblWDep" runat="server" Text="تابع لعيادة" 
            ...
            <tr>
                ...
                <td style="width:120px">
                    <asp:Label ID="lblWName" runat="server" CssClass="rightWithout" 
                        Text="نوع سند الصرف"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Button ID="btnWSave" runat="server" CssClass="myButton" 
                        onclick="btnWSave_Click" Text="حفظ" />
                </td>
                <td style="width:120px">
                    &nbsp;</td>
            </tr>
