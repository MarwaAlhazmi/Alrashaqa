...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
    <td>
                    <asp:TextBox ID="tbDate1" runat="server" CssClass="tb7"></asp:TextBox>
                <ajaxToolkit:CalendarExtender ID="tbDate0_CalendarExtender" runat="server" 
                    Format="yyyy/MM/dd" TargetControlID="tbDate1">
                </ajaxToolkit:CalendarExtender>
                
    </td>
    <td class="style2"><asp:Label ID="lblDate1" runat="server" Text="التاريخ" CssClass="rightWithout" AssociatedControlID="tbDate1"></asp:Label></td>
    </tr>
    <tr>
    <td>
        ...
        <tr>
                 ...
                 <asp:Label ID="lblCheck" runat="server" CssClass="rightWithout" Text="رقم الشيك"></asp:Label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ajaxToolkit:CalendarExtender ID="tbDate_CalendarExtender" runat="server" 
                                Format="yyyy/MM/dd" TargetControlID="tbDate">
                            </ajaxToolkit:CalendarExtender>
                        </td>
                        <td>
                            <asp:Label ID="lblDate" runat="server" CssClass="rightWithout" Text="بتاريخ" 
            ...
            <td>
                <asp:RadioButtonList ID="rbType" runat="server" AutoPostBack="True" 
                    ...
                    <asp:ListItem>مسحوبات البنك</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
