 ...
 <img id="img5" src="Styles/img/chart.png" alt="" />
   <div class="menu_bottom_list">
				<ul class="bottom_item">
					...
					<li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BalanceMov.aspx" class="bottom_link" style="font-size:larger" >حركة حسابات الصندوق</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BalanceMov.aspx?show=1" class="bottom_link" style="font-size:larger" >عرض حركة حسابات الصندوق</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BuffetM.aspx" class="bottom_link" style="font-size:larger" >حركة حسابات البوفيه</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BuffetM.aspx?show=1" class="bottom_link" style="font-size:larger" >عرض حركة حسابات البوفيه</a></li>
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="EandI.aspx" class="bottom_link" style="font-size:larger">بيان بإيرادات ومصروفات العيادة</a></li>
				</ul>
		</div>
 </div>
  <br /><br /><br />
