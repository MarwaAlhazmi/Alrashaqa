<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BrowseDeposit.aspx.cs" Inherits="ClubWebApp.BrowseDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td><h2 class="right">استعراض سندات القبض</h2></td>
    </tr>
    </table>
        ...
        <td>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Bank" HeaderText="على بنك" 
                        SortExpression="Bank" />
                    <asp:BoundField DataField="Date" HeaderText="التاريخ" 
                        SortExpression="Date" DataFormatString="{0:dd/MM/yyyy}" />
                    <asp:BoundField DataField="FromPerson" HeaderText="من" 
                        SortExpression="FromPerson" />
                    <asp:BoundField DataField="AmountW" HeaderText="المبلغ كتابة" 
                        SortExpression="AmountW" />
                    <asp:BoundField DataField="Amount" HeaderText="المبلغ" 
                        SortExpression="Amount" />
                    <asp:BoundField DataField="Employee" HeaderText="الموظفه المستلمه" 
                        SortExpression="Employee" />
                    <asp:BoundField DataField="ID" HeaderText="رقم السند" 
                        SortExpression="ID" ReadOnly="True" />
                    <asp:BoundField DataField="InvID" HeaderText="رقم الفاتورة" 
            ...
            <asp:EntityDataSource ID="edsInvoices" runat="server" 
                ...
                EnableFlattening="False" EntitySetName="Deposits" 
