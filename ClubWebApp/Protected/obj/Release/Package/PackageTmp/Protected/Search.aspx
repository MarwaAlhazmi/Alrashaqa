...
<td>
    <asp:FormView ID="fvResult" runat="server" DataKeyNames="ClientID" 
        ...
        <EditItemTemplate>
            ...
            <br />
            <br />
            <asp:Label ID="Label23" runat="server" Text="جهة التحويل" CssClass="rightWithout" Width="100px"></asp:Label>
        ...
        <ItemTemplate>
            ...
            &nbsp;<asp:LinkButton ID="DeleteButton" runat="server" CausesValidation="False" 
                ...
                &nbsp;<asp:LinkButton ID="SubButton" runat="server" CausesValidation="False" 
                CommandName="Sub" Text="إضافة اشتراك" />
