...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td>
        <asp:TextBox ID="tbID" runat="server" CssClass="tb7" 
            ontextchanged="tbID_TextChanged" AutoPostBack="True"></asp:TextBox>
    ...
    <td style="width:80px">
        ...
        <tr>
            <td>
                <asp:TextBox ID="tbName" runat="server" CssClass="tb7" ReadOnly="True"></asp:TextBox>
            </td>
            <td style="width:80px">
    ...
    <asp:Panel ID="pnlSub" runat="server" GroupingText="الإشتراكات" Visible="False">
        <asp:GridView ID="gvSubs" runat="server" AutoGenerateColumns="False" 
            ...
            Width="100%" ondatabound="gvSubs_DataBound" 
            onrowdatabound="gvSubs_RowDataBound" 
            onselectedindexchanged="gvSubs_SelectedIndexChanged">
