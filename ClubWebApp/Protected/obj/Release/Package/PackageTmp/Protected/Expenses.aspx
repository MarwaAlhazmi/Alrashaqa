<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="ClubWebApp.Expenses" %>
...
<td>
<h2 class="right">بيان بمصروفات المركز اليومية</h2>
</td>
</tr>
</table>
<table width="100%">
    ...
    <td>
        <asp:GridView ID="gvIncome" runat="server" CssClass="rightWithout" Width="100%" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="InvAmount" HeaderText="مبلغ السند" />
                <asp:BoundField DataField="InvNum" HeaderText="رقم السند" />
