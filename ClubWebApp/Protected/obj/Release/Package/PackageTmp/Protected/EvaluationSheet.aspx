<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EvaluationSheet.aspx.cs" Inherits="ClubWebApp.EvaluationSheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate>
    <h2 style="text-align:center">Physical Therapy - Evaluation Sheet</h2>
    ...
    <td>
        ...
        <asp:TextBox ID="tbDia" runat="server" TextMode="MultiLine" Height="90px" 
            ...
            <h3>Brief history / Cheif complaint:</h3>
            <asp:TextBox ID="tbHistory" runat="server" TextMode="MultiLine" Height="90px" 
            Width="900px"></asp:TextBox>

            <h3>Objective evaluation problems:</h3>
        <asp:TextBox ID="tbObjective" runat="server" TextMode="MultiLine" Height="90px" 
            Width="900px"></asp:TextBox>
            <h3>Assessment:</h3>
            <asp:TextBox ID="tbAssess" runat="server" TextMode="MultiLine" Height="90px" 
            Width="900px"></asp:TextBox>
                    <h3>Goals:</h3>
