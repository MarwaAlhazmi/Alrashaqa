   ...
   <asp:Panel ID="pnlMember" runat="server" GroupingText="معلومات المشتركة">
    ...
    <td class="style2">
                ...
                <ajaxToolkit:CalendarExtender ID="tbDate0_CalendarExtender" runat="server" 
                    Format="yyyy/MM/dd" TargetControlID="tbDate">
                </ajaxToolkit:CalendarExtender>
                
    </td>
    <td class="style2"><asp:Label ID="lblDate" runat="server" Text="التاريخ" CssClass="rightWithout" AssociatedControlID="tbFile"></asp:Label></td>
    </tr>
    <tr>
        <td>
       ...
       <tr>
           ...
           <asp:Panel ID="pnlDeposit" runat="server" Visible="false">
               ...
               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                   CellPadding="4" CssClass="rightWithout" DataKeyNames="ID" 
                   DataSourceID="EDSDeposit" ForeColor="#333333" GridLines="None" Width="100%">
                   <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                   <Columns>
                       <asp:CommandField CancelText="إلغاء" EditText="تحرير" ShowEditButton="True" 
                           UpdateText="تحديث" />
                       <asp:BoundField DataField="CheckNum" HeaderText="رقم الشيك" 
                           SortExpression="CheckNum" />
                       <asp:BoundField DataField="Bank" HeaderText="على بنك" SortExpression="Bank" />
                       ...
                       <asp:BoundField DataField="ID" HeaderText="رقم السند" ReadOnly="True" 
                           SortExpression="ID" />
                   </Columns>
               ...
               <asp:EntityDataSource ID="EDSDeposit" runat="server" 
                   AutoGenerateWhereClause="True" ConnectionString="name=ClubDBEntities" 
                   DefaultContainerName="ClubDBEntities" EnableFlattening="False" 
                   EnableUpdate="True" EntitySetName="Deposits" Where="">
                   <WhereParameters>
                       <asp:QueryStringParameter Name="InvID" QueryStringField="Inv" Type="Int32" />
                   </WhereParameters>
