        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="cbEdit" runat="server" AutoPostBack="True" 
                    CssClass="rightWithout" oncheckedchanged="cbEdit_CheckedChanged" Text="تحرير" 
   ...
   <br />
    ...
    <td>
     <asp:TextBox ID="tbCPreBalance" runat="server" CssClass="tb7" AutoPostBack="True" 
        ...
        <asp:ImageButton ID="ibPreBalance" runat="server" CssClass="rightWithout" 
            Height="22px" ImageUrl="~/Styles/img/ajax-loader(4).gif" 
            onclick="ibPreBalance_Click" ToolTip="تحديث" Width="23px" />
    </td>
        ...
        <tr>
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                    ControlToValidate="tbCIncome" CssClass="rightWithout" ErrorMessage="*" 
                    ForeColor="Maroon"></asp:RequiredFieldValidator>
                <asp:ImageButton ID="inIncome" runat="server" CssClass="rightWithout" 
                    Height="22px" ImageUrl="~/Styles/img/ajax-loader(4).gif" 
                    onclick="inIncome_Click" ToolTip="تحديث" Width="23px" />
               </td>
            <td>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" 
                    ControlToValidate="tbCExpenses" CssClass="rightWithout" ErrorMessage="*" 
                    ForeColor="Maroon"></asp:RequiredFieldValidator>
                <asp:ImageButton ID="ibExpenses" runat="server" CssClass="rightWithout" 
                    Height="22px" ImageUrl="~/Styles/img/ajax-loader(4).gif" 
                    onclick="ibExpenses_Click" ToolTip="حديث" Width="23px" />
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
                    ControlToValidate="tbCBank" CssClass="rightWithout" ErrorMessage="*" 
                    ForeColor="Maroon"></asp:RequiredFieldValidator>
                <asp:Label ID="lblBankDate0" runat="server" CssClass="rightWithout" 
                    Width="30px"></asp:Label>
                    <asp:Label ID="lblBankDate" runat="server" CssClass="rightWithout" 
                    Text="تاريخ الإيداع" Visible="False"></asp:Label>
                <asp:TextBox ID="tbBankDate" runat="server" AutoPostBack="True" CssClass="tb7" Visible="False" 
                    ></asp:TextBox>
                <ajaxToolkit:CalendarExtender ID="tbDate0_CalendarExtender" runat="server" 
                    Format="yyyy/MM/dd" TargetControlID="tbBankDate">
                </ajaxToolkit:CalendarExtender>
