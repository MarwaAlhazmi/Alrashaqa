 ...
 <img id="img3" src="Styles/img/create_new_page.png" alt="" />
   <div class="menu_bottom_list">
				<ul class="bottom_item">
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="DeptInvoices.aspx" class="bottom_link" style="font-size:larger">فواتير غير مدفوعه</a></li>
 ...
 <img id="img2" src="Styles/img/computer_monitor.png" alt="" />
   <div class="menu_bottom_list">
				<ul class="bottom_item">
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="CurrentSubs.aspx" class="bottom_link" style="font-size:larger" >اشتراكات اليوم</a></li>
 ...
 <img id="img4" src="Styles/img/application.png" alt="" />
   <div class="menu_bottom_list">
				<ul class="bottom_item">
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BalanceMov.aspx" class="bottom_link" style="font-size:larger" >إدخال حركة حسابات الصندوق</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BuffetM.aspx" class="bottom_link" style="font-size:larger" >إدخال حركة حسابات البوفيه</a></li>
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BrowseDeposit.aspx" class="bottom_link" style="font-size:larger">استعراض سندات القبض</a></li>
				</ul>
		</div>
 </div>
 <br /><br /><br />
 ...
 <img id="img5" src="Styles/img/chart.png" alt="" />
   <div class="menu_bottom_list">
				<ul class="bottom_item">
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BalanceMov.aspx?show=1" class="bottom_link" style="font-size:larger" >حركة حسابات الصندوق</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="BuffetM.aspx?show=1" class="bottom_link" style="font-size:larger" >حركة حسابات البوفيه</a></li>
                    ...
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="Trans.aspx" class="bottom_link" style="font-size:larger">&nbsp;تفصيل بمصروفات المركز</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="EandI.aspx" class="bottom_link" style="font-size:larger">إيرادات ومصروفات العيادة</a></li>
                    <li><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="Bank.aspx" class="bottom_link" style="font-size:larger">كشف حساب البنك</a></li>
				</ul>
		</div>
 </div>
  <br /><br /><br />
 ...
 <img id="img7" src="Styles/img/view_page.png" alt="" />
   <div class="menu_bottom_list">
				<ul class="bottom_item">
					...
					<li style="height: 24px"><img src="Styles/img/arrow.png" class="arrow" alt="" /><a href="DischargeBrowse.aspx" class="bottom_link" style="font-size:larger">عرض ملخص خروج - علاج طبيعي</a></li>
					<li style="height: 23px"><img src="Styles/img/arrow.png" class="arrow" alt="" /><a 
                            href="EvaluationBrowse.aspx" class="bottom_link" style="font-size:larger">عرض نموذج تقييم حالة</a></li>
