...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td>
    <h2 class="rightWithout"> اشتراك </h2>
    </td>
    </tr>
    </table> 
    ...
    <td style="width:90px">
       ...
       <td>
           <asp:DropDownList ID="ddlDep" runat="server" AppendDataBoundItems="True" 
               ...
               onselectedindexchanged="ddlDep_SelectedIndexChanged" Width="200px">
       ...
       <td style="width:100px">
           ...
           <tr>
               <td>
                   <asp:TextBox ID="tbHistory" runat="server" CssClass="tb7" Height="25px" 
                       Width="600px"></asp:TextBox>
               </td>
               <td style="width: 100px">
                   <asp:Label ID="lblHistory" runat="server" CssClass="rightWithout" 
